    ...
    <Card className="shadow-xl">
      <CardHeader className="border-b">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-start space-x-4 min-w-0"> {/* Changed items-center to items-start for better name alignment, added min-w-0 */}
            ...
            <div className="min-w-0 flex-1"> {/* Added min-w-0 and flex-1 */}
              <CardTitle className="text-2xl sm:text-3xl font-headline flex items-center">
                <span className="break-words min-w-0">{prospect.name}</span> {/* Wrapped name in span for breaking */}
